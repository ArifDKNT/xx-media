            ...
            <div className="fixed z-50 inset-0 overflow-y-auto">
                <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    >
                        ...
                        <form className='px-4 sm:px-6 flex flex-col gap-3 2xl:gap-6 pb-6' onSubmit={handleSubmit(onSubmit)}>
                            <TextInput
                                label='First Name'
...
{isSubmitting ? <Loading/> : <CustomButton type='submit' containerStyle={`inline-flex justify-center rounded-md bg-blue px-8 py-3 text-sm font-medium text-white outline-none`} title='Submit' />}
                        </form>
