            ...
            <div className="flex items-end justify-end pb-2">
                {loading ? (
                    ...
                    <CustomButton
                        title={"Submit"}
                        type={"submit"}
                        containerStyle={"bg-[#0444a4] text-white py-1 px-3 rounded-full font-semibold text-sm"}
            ...
            <div>
                <p className="text-ascent-2">
                    ...
                    {post?.description?.length > 301 && (showAll === post?._id ?
                        ...
                        <span onClick={() => setShowAll(post?._id)} className='text-blue ml-2 font-medium cursor-pointer'>Show More</span>)}
                </p>
            ...
            {showComments === post?._id && (
                <div className='w-full mt-4 border-t border-[#66666645]'>
                    ...
                    {loading ? (
                        ...
                        (<span className='flex text-sm py-4 text-ascent-2 text-center' >No Commnets , be first to comment</span>)}
                </div>
            )}
