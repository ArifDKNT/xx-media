            ...
            <div className="w-full md:w-2/3 h-fit lg:h-full 2xl:h-5/6 py-8 lg:py-0 flex flex-row-reverse bg-primary rounded-xl overflow-hidden shadow-xl">
                ...
                <div className="w-full lg:w=1/2 h-full p-10 2xl:px-20 flex flex-col justify-center" >
                    ...
                    <form className="py-8 flex flex-col gap-5" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        {isSubmitting ? <Loading /> : <CustomButton type='submit' containerStyle={`inline-flex justify-center rounded-md bg-blue px-8 py-3 text-sm font-medium text-white outline-none`} title='Create Account' />}
                    </form>
                ...
                <div className="hidden w-1/2 h-full lg:flex flex-col items-center justify-center bg-blue">
                    ...
                    <div className="mt-16 text-center">
                        ...
                        <span className="text-sm text-white/80">
                            Share memories with friends all around the world
                        </span>
                    </div>
                </div>
